...
const TaskQueuePanel: React.FC<TaskQueuePanelProps> = ({
  ...
  return (
    <div className="absolute top-4 right-4 z-40 min-w-[280px] bg-gray-900 bg-opacity-80 rounded-xl p-3 border-4 border-gray-600 pixel-border shadow-xl animate-fade-in max-h-[80vh] overflow-y-auto">
