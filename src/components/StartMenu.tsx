  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[600px] p-6 bg-gradient-to-b from-game-primary/10 to-white">
      <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center text-game-dark leading-tight">
        Caos no Escritório
        <span className="block text-game-primary">MercadoLivre Edition</span>
      </h1>
      ...
      <div className="flex flex-col gap-4 w-64">
        <Button 
          onClick={onStartGame} 
          className="py-6 text-lg bg-[#ffeb00] text-zinc-950 hover:bg-[#ffd700]"
        >
          Iniciar Caos
        </Button>
        <Button 
          onClick={onHowToPlay} 
          variant="outline" 
          className="border-[#ffeb00] bg-transparent text-zinc-800 hover:bg-[#ffeb00]/10"
        >
          Como Jogar
        </Button>
      </div>
